...
interface AddHotelDialogProps {
    hotelToEdit: Hotel ;
    setHotelToEdit: React.Dispatch<
        React.SetStateAction<Hotel | undefined>
    >;
    saveHotelChanges: (hotelData: Hotel) => void;
}
...
function EditHotelDialog({
    ...
    const [hotelData, setHotelData] = useState<Hotel>(hotelToEdit);
    ...
    return (
        ...
        >
            ...
            <DialogActions sx={{ paddingBottom: 3 }}>
                <Button
                    onClick={() => saveHotelChanges(hotelData)}
                ...
                <Button
                    onClick={() => setHotelToEdit(undefined)}
